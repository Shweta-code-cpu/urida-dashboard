const BASE_URL = "http://192.168.3.106:8385/Gorakhpur";
...
var view = new ol.View({
    ...
    center: [83.39706436902927, 26.75461034040767],
    zoom: 12,
});
...
var zone_boundary = new ol.layer.Image({
    ...
    source: new ol.source.ImageWMS({
        url: "http://localhost:8080/geoserver/Gorakhpur/wms?",
        params: {
            LAYERS: "Gorakhpur:Gorakhpur Zone Boundary",
        },
        ratio: 1,
...
var ward_boundary = new ol.layer.Image({
    ...
    source: new ol.source.ImageWMS({
        url: "http://localhost:8080/geoserver/Gorakhpur/wms?",
        params: {
            LAYERS: "Gorakhpur:Gorakhpur Ward Boundary",
        },
        ratio: 1,
        serverType: "geoserver",
    }),
...
$(document).ready(function () {
    ...
    var wfsParams = {
        ...
        typeName: 'All_NN_roads:Gorakhpur Road', // Replace with your WFS layer typename
    ...
    const url = 'http://localhost:8080/geoserver/wfs?service=WFS&version=1.0.0&request=GetFeature&typeName=All_NN_roads:Gorakhpur Road&outputFormat=application/json';
...
function Gorakhpur_Road() {
    ...
    currentLayer = new ol.layer.Image({
        ...
        source: new ol.source.ImageWMS({
            ...
            params: {
                'LAYERS': 'All_NN_roads:Gorakhpur Road',
