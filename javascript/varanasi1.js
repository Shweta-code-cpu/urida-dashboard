...
var zone_boundary = new ol.layer.Image({
    title: "Varanasi Zone Boundary",
    //  extent: [-180, -90, -180, 90],
    source: new ol.source.ImageWMS({
        url: `${GEOSERVER_BASE_URL}/wms`,
        params: {
            LAYERS: "VNS_Summary:varanasi_zone_boundary",
        },
        ratio: 1,
...
var ward_boundary = new ol.layer.Image({
    title: "Varanasi Ward Boundary",
    //  extent: [-180, -90, -180, 90],
    source: new ol.source.ImageWMS({
       url: `${GEOSERVER_BASE_URL}/wms`,
        params: {
            LAYERS: "VNS_Summary:varanasi_ward_boundary",
        },
        ratio: 1,
        serverType: "geoserver",
    }),
...
function clearAllVectorLayers() {
    ...
    map.getLayers().getArray().slice().forEach(layer => {
        if ((layer instanceof ol.layer.Tile || layer instanceof ol.layer.Image) &&
            ...
            if (layer.get('title') !== 'Varanasi Zone Boundary' && layer.get('title') !== 'Varanasi Ward Boundary') {
...
function updateSummary(data) {
    ...
    const summaryData = {
        ...
        'Road Count by Condition': {
            value: `
                Good - <a href="javascript:void(0)" onclick="Varanasi_Condition_cat('condition','Good'); updateNavBarWithFunctionName('Road Condition : Good');" style="color:green;">${safeValue('condition_count_green')}</a><br>
                Poor - <a href="javascript:void(0)" onclick="Varanasi_Condition_cat('condition','Poor'); updateNavBarWithFunctionName('Road Condition : Poor');" style="color:red;">${safeValue('condition_count_red')}</a><br>
                Moderate - <a href="javascript:void(0)" onclick="Varanasi_Condition_cat('condition','Moderate'); updateNavBarWithFunctionName('Road Condition : Moderate');" style="color:yellow;">${safeValue('condition_count_yellow')}</a><br>
                NA - <a href="javascript:void(0)" onclick="Varanasi_Condition_cat('condition','NA'); updateNavBarWithFunctionName('Road Condition : NA');" style="color:pink;">${safeValue('condition_count_na')}</a><br>
            `,
            onclick: 'Varanasi_Condition()'
        },
        'Road Count by Material': {
            value: `
                ...
                `,
            onclick: 'Varanasi_Material()'
        },
        'Road Count by Ownership': {
            value: `
                Nagar Nigam - <a href="javascript:void(0)" onclick="Varanasi_Ownership_cat('ownership','Nagar Nigam'); updateNavBarWithFunctionName('Road Ownership : Varanasi Nagar Nigam');" style="color:#5aeee5;">${safeValue('count_nn')}</a><br>
                PWD - <a href="javascript:void(0)" onclick="Varanasi_Ownership_cat('ownership','PWD'); updateNavBarWithFunctionName('Road Ownership :  PWD');" style="color:#69e70f;">${safeValue('count_pwd')}</a><br>
                Development Authority - <a href="javascript:void(0)" onclick="Varanasi_Ownership_cat('ownership','MVDA'); updateNavBarWithFunctionName('Road Ownership : Development Authority');" style="color:#f16a16;">${safeValue('count_da')}</a><br>
                Private Roads - <a href="javascript:void(0)" onclick="Varanasi_Ownership_cat('ownership','Private Road'); updateNavBarWithFunctionName('Road Ownership : Private Road');" style="color:#ed2323;">${safeValue('count_pvt')}</a><br>
                Defence - <a href="javascript:void(0)" onclick="Varanasi_Ownership_cat('ownership','Defence'); updateNavBarWithFunctionName('Road Ownership : Defence');" style="color:#f16a16;">${safeValue('count_defence')}</a><br>
                NHAI - <a href="javascript:void(0)" onclick="Varanasi_Ownership_cat('ownership','NHAI'); updateNavBarWithFunctionName('Road Ownership : NHAI');" style="color:#ed2323;">${safeValue('count_nhai')}</a><br>
                Railway - <a href="javascript:void(0)" onclick="Varanasi_Ownership_cat('ownership','Railway'); updateNavBarWithFunctionName('Road Ownership : Railway');" style="color:#ed2323;">${safeValue('count_railway')}</a><br>
                Departmental Roads - <a href="javascript:void(0)" onclick="Varanasi_Ownership_cat('ownership','Departmental Roads'); updateNavBarWithFunctionName('Road Ownership : Departmental Roads');" style="color:#ed2323;">${safeValue('count_depart')}</a><br>
                Institutional Roads - <a href="javascript:void(0)" onclick="Varanasi_Ownership_cat('ownership','Institutional Roads'); updateNavBarWithFunctionName('Road Ownership : Institutional Roads');" style="color:#ed2323;">${safeValue('count_instit')}</a><br>

                `,
            onclick: 'Varanasi_Ownership()'
        },
        'Road Count by CUS': {
            value: `
                14th Finance - <a href="javascript:void(0)" onclick="Varanasi_CUS_cat('cus_class','14th Finance'); updateNavBarWithFunctionName('Road CUS : 14th Finance');" style="color: #e63dee;">${safeValue('count_14th')}</a><br>
                15th Finance - <a href="javascript:void(0)" onclick="Varanasi_CUS_cat('cus_class','15th Finance'); updateNavBarWithFunctionName('Road CUS : 15th Finance');" style="color: #e63dee;">${safeValue('count_15th')}</a><br>
                Nagar Nigam Nidhi - <a href="javascript:void(0)" onclick="Varanasi_CUS_cat('cus_class','Nagar Nigam Nidhi'); updateNavBarWithFunctionName('Road CUS : Nagar Nigam Nidhi');" style="color: cyan;">${safeValue('count_nnn')}</a><br>
                PWD - <a href="javascript:void(0)" onclick="Varanasi_CUS_cat('cus_class','PWD'); updateNavBarWithFunctionName('Road CUS : PWD');" style="color: #173dd6;">${safeValue('count_cus_pwd')}</a><br>
                VDA - <a href="javascript:void(0)" onclick="Varanasi_CUS_cat('cus_class','VDA'); updateNavBarWithFunctionName('Road CUS : VDA');" style="color: #6e52e7;">${safeValue('count_cus_vda')}</a><br>
                DUDA - <a href="javascript:void(0)" onclick="Varanasi_CUS_cat('cus_class','DUDA'); updateNavBarWithFunctionName('Road CUS : DUDA');" style="color: #8717e2;">${safeValue('count_cus_duda')}</a><br>
                Others - <a href="javascript:void(0)" onclick="Varanasi_CUS_cat('cus_class','Others'); updateNavBarWithFunctionName('Road CUS : Others');" style="color: #45d1a5;">${safeValue('count_cus_others')}</a><br>
                NA - <a href="javascript:void(0)" onclick="Varanasi_CUS_cat('cus_class','NA'); updateNavBarWithFunctionName('Road CUS : NA');" style="color: #8717e2;">${safeValue('count_cus_na')}</a><br>
                `
            ,
           // onclick: 'Varanasi_CUS()'
        },
        'Road Count by Category': {
            value: `
                NA - <a href="javascript:void(0)" onclick="Varanasi_TypeSub_cat('category','NA'); updateNavBarWithFunctionName('Road Category : NA');" style="color: #8717e2;">${safeValue('count_expressway')}</a><br>

                `, onclick: 'Varanasi_Category()'
        }
    };
...
function updateZones(zoneNo, zoneName, data) {
    ...
    const zoneCards = [
        { 
            ...
            value: `<a href="javascript:void(0)" onclick="Varanasi_Zone_no('zone_no','${zoneNo}'); updateNavBarWithFunctionName('Zone-${zoneNo} Total Road Length');" style="color:black;">${data.length_km.toFixed(2)} km</a>` 
        },
        { 
            title: 'Total No. of Roads', 
            value: `<a href="javascript:void(0)" onclick="Varanasi_Zone_no('zone_no','${zoneNo}'); updateNavBarWithFunctionName('Zone-${zoneNo} Total Road Count');" style="color:black;">${data.total_no_of_roads}</a>` 
        },
        { 
            title: 'Road Condition', 
            value: `
                    Good <a href="javascript:void(0)" onclick="Varanasi_Zone_Condition('${zoneNo}','condition','Good'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Condition : Good');" style="color:green;">- ${data.count_green}</a> <br> 
                    Moderate <a href="javascript:void(0)" onclick="Varanasi_Zone_Condition('${zoneNo}','condition','Moderate'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Condition : Moderate');" style="color:yellow;">- ${data.count_yellow}</a> <br> 
                    Poor <a href="javascript:void(0)" onclick="Varanasi_Zone_Condition('${zoneNo}','condition','Poor'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Condition : Poor');" style="color:red;">- ${data.count_red}</a><br>
                    NA <a href="javascript:void(0)" onclick="Varanasi_Zone_Condition('${zoneNo}','condition','NA'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Condition : NA');" style="color:pink;">- ${data.condition_count_na}</a> <br> 
                    `
        },
        { 
            title: 'Materials', 
        ...
        { 
            ...
            value: `
                    ...
                    Railway - <a href="javascript:void(0)" onclick="Varanasi_Zone_Ownership('${zoneNo}','ownership','Railway'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership : Railway');" style="color:#ed2323;">${data.count_railway}</a><br>
                    Departmental Roads - <a href="javascript:void(0)" onclick="Varanasi_Zone_Ownership('${zoneNo}','ownership','Departmental Roads'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership : Departmental Roads');" style="color:#ed2323;">${data.count_depart}</a><br>
                    Institutional Roads - <a href="javascript:void(0)" onclick="Varanasi_Zone_Ownership('${zoneNo}','ownership','Institutional Roads'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership : Institutional Roads');" style="color:#ed2323;">${data.count_instit}</a><br>
                    `
                },
                 {
                    title: 'cus_class',
                    value: ` 
                        ...
                        Others - <a href="javascript:void(0)" onclick="Varanasi_Zone_CUS('${zoneNo}','cus_class','Others'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS : Others');" style="color: #c53465;">${data.count_cus_others}</a><br>
                        NA - <a href="javascript:void(0)" onclick="Varanasi_Zone_CUS('${zoneNo}','cus_class','NA'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS : NA');" style="color: #8717e2;">${data.count_cus_na}</a><br>
                        `  
                    },
               {
        ...
        .then(responseData => {
            if (responseData.status) {
                ...
                const details = [
                    ...
                    { 
                        title: 'Total No. of Roads', 
                        value: `<a href="javascript:void(0)" onclick="Varanasi_Ward_no('ward_no', '${wardNo}'); updateNavBarWithFunctionName('Ward-${wardNo} Total Road Count');" style="color:black;">${responseData.total_no_of_roads}</a>` 
                    },
                    { 
                        title: 'Road Condition', 
                        value: `
                                Good - <a href="javascript:void(0)" onclick="Varanasi_Ward_Condition('${wardNo}', 'condition', 'Good'); updateNavBarWithFunctionName('Ward-${wardNo} Road Condition : Good');" style="color:green;">${responseData.count_green}</a><br> 
                                Moderate - <a href="javascript:void(0)" onclick="Varanasi_Ward_Condition('${wardNo}', 'condition', 'Moderate'); updateNavBarWithFunctionName('Ward-${wardNo} Road Condition : Moderate');" style="color:yellow;">${responseData.count_yellow}</a><br> 
                                Poor - <a href="javascript:void(0)" onclick="Varanasi_Ward_Condition('${wardNo}', 'condition', 'Poor'); updateNavBarWithFunctionName('Ward-${wardNo} Road Condition : Poor');" style="color:red;">${responseData.count_red}</a><br>
                                NA - <a href="javascript:void(0)" onclick="Varanasi_Ward_Condition('${wardNo}', 'condition', 'NA'); updateNavBarWithFunctionName('Ward-${wardNo} Road Condition : NA');" style="color:pink;">${responseData.condition_count_na}</a>
                                ` 
                            },
                    { 
                        title: 'Materials', 
                    ...
                    { 
                        title: 'Ownership', 
                        value: `
                                PNN - <a href="javascript:void(0)" onclick="Varanasi_Ward_Ownership('${wardNo}', 'ownership','Nagar Nigam'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership : Varanasi Nagar Nigam');" style="color:#5aeee5;">${responseData.count_nn}</a><br>
                                PWD - <a href="javascript:void(0)" onclick="Varanasi_Ward_Ownership('${wardNo}', 'ownership', 'PWD'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership : PWD');" style="color:#69e70f;">${responseData.count_pwd}</a><br> 
                                PVT - <a href="javascript:void(0)" onclick="Varanasi_Ward_Ownership('${wardNo}', 'ownership', 'Private Road'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership : Private Roads');" style="color:#ed2323;">${responseData.count_pvt}</a><br>
                                Development Authority - <a href="javascript:void(0)" onclick="Varanasi_Ward_Ownership('${wardNo}', 'ownership', 'Development Authority'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership : Varanasi Development Authority');" style="color:#f16a16;">${responseData.count_da}</a><br>
                                Defence - <a href="javascript:void(0)" onclick="Varanasi_Ward_Ownership('${wardNo}','ownership','Defence'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership : Defence');" style="color:#f16a16;">${responseData.count_defence}</a><br>
                                NHAI - <a href="javascript:void(0)" onclick="Varanasi_Ward_Ownership('${wardNo}','ownership','NHAI'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership : NHAI');" style="color:#ed2323;">${responseData.count_nhai}</a><br>
                                Railway - <a href="javascript:void(0)" onclick="Varanasi_Ward_Ownership('${wardNo}','ownership','Railway'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership : Railway');" style="color:#ed2323;">${responseData.count_railway}</a><br>
                                Departmental Roads - <a href="javascript:void(0)" onclick="Varanasi_Ward_Ownership('${wardNo}','ownership','Departmental Roads'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership : Departmental Roads');" style="color:#ed2323;">${responseData.count_depart}</a><br>
                                Institutional Roads - <a href="javascript:void(0)" onclick="Varanasi_Ward_Ownership('${wardNo}','ownership','Institutional Roads'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership : Institutional Roads');" style="color:#ed2323;">${responseData.count_instit}</a><br>
                                `},
                    {
                        title: 'CUS',
                         value: `                                
                                14th Finance - <a href="javascript:void(0)" onclick="Varanasi_Ward_CUS('${wardNo}','cus_class','14th Finance'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS : 14th Finance');" style="color: #e63dee;">${responseData.count_14th}</a><br>
                                15th Finance - <a href="javascript:void(0)" onclick="Varanasi_Ward_CUS('${wardNo}','cus_class','15th Finance'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS : 15th Finance');" style="color: #e63dee;">${responseData.count_15th}</a><br>
                                Nagar Nigam Nidhi - <a href="javascript:void(0)" onclick="Varanasi_Ward_CUS('${wardNo}','cus_class','Nagar Nigam Nidhi'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS : Nagar Nigam Nidhi');" style="color:cyan;">${responseData.count_nnn}</a><br>
                                PWD - <a href="javascript:void(0)" onclick="Varanasi_Ward_CUS('${wardNo}','cus_class','PWD'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS : PWD');" style="color: #14ea54;">${responseData.count_cus_pwd}</a><br>
                                DUDA - <a href="javascript:void(0)" onclick="Varanasi_Ward_CUS('${wardNo}','cus_class','DUDA'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS : DUDA');" style="color: #173dd6;">${responseData.count_cus_duda}</a><br>
                                VDA - <a href="javascript:void(0)" onclick="Varanasi_Ward_CUS('${wardNo}','cus_class','VDA'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS : VDA');" style="color: #6e52e7;">${responseData.count_cus_vda}</a><br>
                                NA - <a href="javascript:void(0)" onclick="Varanasi_Ward_CUS('${wardNo}','cus_class','NA'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS : NA');" style="color: #8717e2;;">${responseData.count_cus_na}</a><br>
                                Others - <a href="javascript:void(0)" onclick="Varanasi_Ward_CUS('${wardNo}','cus_class','Others'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS : Others');" style="color: #8717e2;;">${responseData.count_cus_others}</a><br>
                                `  },
                    {
                        title: 'Type Sub Category',
                        value: `
...
function Varanasi_Road_Length_Count() {
    ...
    currentLayer = new ol.layer.Image({
        ...
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'VNS_Summary:varanasi_road_net',
...
function Varanasi_Ownership(cqlFilter) {
    ...
    currentLayer = new ol.layer.Image({
        ...
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS':'VNS_Summary:varanasi_road_own',                               
...
function Varanasi_Material(cqlFilter) {
    removeCurrentLayer(); clearVectorLayers();
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS':'VNS_Summary:varanasi_road_mat',                                  
                'CQL_FILTER': cqlFilter,
            },
            ratio: 1,
            serverType: 'geoserver'
...
function Varanasi_Category(cqlFilter) {
    removeCurrentLayer(); clearVectorLayers();
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'VNS_Summary:varanasi_road_category',                                                       
                'CQL_FILTER': cqlFilter,
            },
            ratio: 1,
            serverType: 'geoserver'
...
function Varanasi_Condition(cqlFilter) {
    removeCurrentLayer(); clearVectorLayers();
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'VNS_Summary:varanasi_road_condition',                                                       
                'CQL_FILTER': cqlFilter,
            },
            ratio: 1,
            serverType: 'geoserver'
...
function Varanasi_Zone_no(column, value) {
    removeCurrentLayer();
   // clearVectorLayers();
...
function Varanasi_Ward_no(column, value) {
    removeCurrentLayer();
   // clearVectorLayers();
...
function Varanasi_Condition_cat(column, value) {
    removeCurrentLayer();
  ///  clearVectorLayers();
    // Define dynamic CQL filter
    let cqlFilter = `(${column}='${value}' OR ${column} ILIKE '%/${value}' OR ${column} ILIKE '${value}/%' OR ${column} ILIKE '%/${value}/%' OR ${column} ILIKE '${value}')`;
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'VNS_Summary:varanasi_road_condition',   // Same layer for all filters
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Varanasi_Material_cat(column, value) {
    removeCurrentLayer();
  //  clearVectorLayers();
    // Define dynamic CQL filter
    let cqlFilter = `(${column}='${value}' OR ${column} ILIKE '%/${value}' OR ${column} ILIKE '${value}/%' OR ${column} ILIKE '%/${value}/%' OR ${column} ILIKE '${value}')`;
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'VNS_Summary:varanasi_road_mat',  // Same layer for all filters
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Varanasi_Ownership_cat(column, value) {
    removeCurrentLayer();
  //  clearVectorLayers();
    // Define dynamic CQL filter
    let cqlFilter = `(${column}='${value}' OR ${column} ILIKE '%/${value}' OR ${column} ILIKE '${value}/%' OR ${column} ILIKE '%/${value}/%' OR ${column} ILIKE '${value}')`;
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS':'VNS_Summary:varanasi_road_own',   // Same layer for all filters
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Varanasi_CUS_cat(column, value) {
    removeCurrentLayer();
   // clearVectorLayers();
    // Define dynamic CQL filter
    let cqlFilter = `(${column}='${value}' OR ${column} ILIKE '%/${value}' OR ${column} ILIKE '${value}/%' OR ${column} ILIKE '%/${value}/%' OR ${column} ILIKE '${value}')`;
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'VNS_Summary:varanasi_road_cus',   // Same layer for all filters
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Varanasi_TypeSub_cat(column, value) {
    removeCurrentLayer();
   // clearVectorLayers();
    // Define dynamic CQL filter
    let cqlFilter = `(${column}='${value}' OR ${column} ILIKE '%/${value}' OR ${column} ILIKE '${value}/%' OR ${column} ILIKE '%/${value}/%' OR ${column} ILIKE '${value}')`;
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'VNS_Summary:varanasi_road_category',   // Same layer for all filters
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Varanasi_Zone_Condition(zone_no, column, value) {
    removeCurrentLayer();
  //  clearVectorLayers();
...
function Varanasi_Zone_Material(zone_no, column, value) {
    removeCurrentLayer();
  //  clearVectorLayers();
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS':'VNS_Summary:varanasi_road_mat',   // Main layer for filtering
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Varanasi_Zone_Ownership(zone_no, column, value) {
    removeCurrentLayer();
   // clearVectorLayers();
    // Ensure column is valid to prevent errors
    let validColumns = ["condition", "category", "material", "ownership", "cus"];
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'VNS_Summary:varanasi_road_own',   // Main layer for filtering
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Varanasi_Zone_CUS(zone_no, column, value) {
    removeCurrentLayer();
   // clearVectorLayers();
    // Ensure column is valid to prevent errors
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'VNS_Summary:varanasi_road_cus',   // Main layer for filtering
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Varanasi_Zone_TypeSub(zone_no, column, value) {
    removeCurrentLayer();
    clearVectorLayers();
    // Ensure column is valid to prevent errors
    let validColumns = ["condition", "category", "material", "ownership", "cus",];
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'VNS_Summary:varanasi_road_category',   // Main layer for filtering
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Varanasi_Ward_Condition(ward_no, column, value) {
    removeCurrentLayer();
  //  clearVectorLayers();
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS':'VNS_Summary:varanasi_road_condition', // Main layer for filtering
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Varanasi_Ward_Material(ward_no, column, value) {
    removeCurrentLayer();
   // clearVectorLayers();
    // Ensure column is valid to prevent errors
    let validColumns = ["condition", "category", "material", "ownership", "cus"];
...
function Varanasi_Ward_Ownership(ward_no, column, value) {
    removeCurrentLayer();
  //  clearVectorLayers();
...
function Varanasi_Ward_CUS(ward_no, column, value) {
    removeCurrentLayer();
   // clearVectorLayers();
...
function Varanasi_Ward_TypeSub(ward_no, column, value) {
    removeCurrentLayer();
    clearVectorLayers();
    // Ensure column is valid to prevent errors
    let validColumns = ["condition", "category", "material", "ownership","cus"];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const filters = ['ward', 'ownership', 'condition', 'material'];
...
function determineLayer() {
    if (selectedFilters.material) {
        ...
        document.getElementById('RoadCategory_legend').style.display = 'none';
        document.getElementById('Ownership_legend').style.display = 'none';
        return 'VNS_Summary:varanasi_road_mat';
    } 
    ...
    //     document.getElementById('Ownership_legend').style.display = 'none';
    //     document.getElementById('Material_legend').style.display = 'none';
    //     return 'VNS_Summary:varanasi_road_category';
    // } 
        ...
        document.getElementById('RoadCategory_legend').style.display = 'none';
        document.getElementById('Material_legend').style.display = 'none';
        return 'VNS_Summary:varanasi_road_own';
    } 
        ...
        document.getElementById('Ownership_legend').style.display = 'none';
        document.getElementById('Material_legend').style.display = 'none';
        return 'VNS_Summary:varanasi_road_condition';
    }
    return 'VNS_Summary:varanasi_road_net';
}
