...
function showTables() {
    ...
    hideElements(['legendBtn', 'live_legend', 'type_legend', 'Condition_legend', 'CUS_legend', 'RoadCategory_legend', 'Material_legend', 'Ownership_legend',
        'tableContainer_summary', 'summary-table', 'tableContainer_summaryfilter',
...
function showTables3() {
    ...
    hideElements([
        'dataTable', 'tableContainer', 'tableContainer_summary', 'live_legend', 'Under_Scheme_legend',
...
function maximize1() {
    ...
    const navElements = document.querySelectorAll('.feature_nav');
    navElements.forEach(nav => {
        nav.style.bottom = '32%'; // Reduced width when minimized
    });
...
$(function () {
    ...
    $.ajax({
        ...
        success: function (xml) {
            var select = $("#layer1");
            var targetWorkspace = "Lko_Summary:lucknow_road_net"; // 👈 workspace prefix
            ...
            function clearAllVectorLayers() {
                ...
                const elementsToHide = ["tableContainer", "road-filter", "filterBox", "query_tab", "popup_road", "tableContainer_summary", "Scoreing_tableContainer",
            ...
            function updateSummary(data) {
                ...
                const summaryData = {
                    'No. of Zones': { value: safeValue('zone_count'), onclick: 'Lucknow_Zone_no()' },
                    'Total Road Length': { value: `${safeValue('total_length_km')} km`, onclick: "Lucknow_Road_Length_Count(); updateNavBarWithFunctionName('Total Road Length');" },
                    'Total No. of Roads': { value: safeValue('total_length_count'), onclick: "Lucknow_Road_Length_Count(); updateNavBarWithFunctionName('Total Road Count');" },
                    'Total Ward No.': { value: safeValue('lko_ward'), onclick: 'Lucknow_Ward_NO()' },
                    'Road Count by Condition': {
                        value: `
                Good - <a href="javascript:void(0)" onclick="Lucknow_Condition_cat('condition','Good'); updateNavBarWithFunctionName('Road Condition Good');" style="color:green;">${safeValue('condition_count_green')}</a><br>
                Poor - <a href="javascript:void(0)" onclick="Lucknow_Condition_cat('condition','Poor'); updateNavBarWithFunctionName('Road Condition Poor');" style="color:red;">${safeValue('condition_count_red')}</a><br>
            ...
            `
                ...
                Railway - <a href="javascript:void(0)" onclick="Lucknow_Ownership_cat('ownership','Railway'); updateNavBarWithFunctionName('Road Ownership Railway');" style="color:#f16a16;">${safeValue('count_railway')}</a><br>
                Private Roads - <a href="javascript:void(0)" onclick="Lucknow_Ownership_cat('ownership','Private'); updateNavBarWithFunctionName('Road Ownership Private Roads');" style="color:#ed2323;">${safeValue('count_pvt')}</a><br>
                NHAI - <a href="javascript:void(0)" onclick="Lucknow_Ownership_cat('ownership','NHAI'); updateNavBarWithFunctionName('Road Ownership NHAI');" style="color:#5aeee5;">${safeValue('count_nhai')}</a><br>
                ...
                Defence - <a href="javascript:void(0)" onclick="Lucknow_Ownership_cat('ownership','Defence'); updateNavBarWithFunctionName('Road Ownership Defence');" style="color:#ed2323;">${safeValue('count_defence')}</a><br>
                C.M Grid - <a href="javascript:void(0)" onclick="Lucknow_Ownership_cat('ownership','C.M Grid'); updateNavBarWithFunctionName('Road Ownership C.M Grid');" style="color:#5aeee5;">${safeValue('count_grid')}</a><br>
                Department Roads - <a href="javascript:void(0)" onclick="Lucknow_Ownership_cat('ownership','Department Roads'); updateNavBarWithFunctionName('Road Ownership Department Roads');" style="color:#f16a16;">${safeValue('count_department')}</a><br>
                Institutional Roads - <a href="javascript:void(0)" onclick="Lucknow_Ownership_cat('ownership','Institutional Road'); updateNavBarWithFunctionName('Road Ownership Institutional Roads');" style="color:#ed2323;">${safeValue('count_institutional')}</a><br>
                `,
                        onclick: 'Lucknow_Ownership()'
                    },
                    'Road Count by CUS': {
                        value: `
                14th Finance - <a href="javascript:void(0)" onclick="Lucknow_CUS_cat('cus','14th Finance'); updateNavBarWithFunctionName('Road CUS 14th Finance');" style="color: #ec1248;">${safeValue('count_14th')}</a><br>
                ...
                PWD - <a href="javascript:void(0)" onclick="Lucknow_CUS_cat('cus','PWD'); updateNavBarWithFunctionName('Road CUS PWD');" style="color: #173dd6;">${safeValue('count_cus_pwd')}</a><br>
                Private - <a href="javascript:void(0)" onclick="Lucknow_CUS_cat('cus','Private'); updateNavBarWithFunctionName('Road CUS Private');" style="color: #14ea54;">${safeValue('count_cus_pvt')}</a><br>
                Duda - <a href="javascript:void(0)" onclick="Lucknow_CUS_cat('cus','Duda'); updateNavBarWithFunctionName('Road CUS Duda');" style="color: #d4b85a;">${safeValue('count_cus_duda')}</a><br>
                LDA - <a href="javascript:void(0)" onclick="Lucknow_CUS_cat('cus','LDA'); updateNavBarWithFunctionName('Road CUS LDA');" style="color: #e6497d;">${safeValue('count_cus_lda')}</a><br>
                Railway - <a href="javascript:void(0)" onclick="Lucknow_CUS_cat('cus','Railway'); updateNavBarWithFunctionName('Road CUS Railway');" style="color: #8717e2;">${safeValue('count_cus_railway')}</a><br>
                NA- <a href="javascript:void(0)" onclick="Lucknow_CUS_cat('cus','NA'); updateNavBarWithFunctionName('Road CUS NA');" style="color: #bad057;">${safeValue('count_cus_na')}</a><br>
                Others- <a href="javascript:void(0)" onclick="Lucknow_CUS_cat('cus_class','Others'); updateNavBarWithFunctionName('Road CUS Others');" style="color: orange;">${safeValue('count_cus_others')}</a><br>
                ...
                Sub Arterial - <a href="javascript:void(0)" onclick="Lucknow_TypeSub_cat('category','Subarterial'); updateNavBarWithFunctionName('Road Category Sub Arterial');" style="color: #83e45c;">${safeValue('count_subarterial')}</a><br>
            ...
            function updateZones(zoneNo, zoneName, data) {
                ...
                const zoneCards = [
...

                    {
                        ...
                        value: `Good <a href="javascript:void(0)" onclick="Lucknow_Zone_Condition('${zoneNo}','condition','Good'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Condition Good');" style="color:green;">- ${data.count_green}</a> <br> 
                    Moderate <a href="javascript:void(0)" onclick="Lucknow_Zone_Condition('${zoneNo}','condition','Moderate'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Condition Moderate');" style="color:yellow;">- ${data.count_yellow}</a> <br> 
                    Poor <a href="javascript:void(0)" onclick="Lucknow_Zone_Condition('${zoneNo}','condition','Poor'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Condition Poor');" style="color:red;">- ${data.count_red}</a><br>
                    ...
                    Private Roads <a href="javascript:void(0)" onclick="Lucknow_Zone_Ownership('${zoneNo}','ownership','Private'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership Private Roads');" style="color:#ed2323;">- ${data.count_pvt}</a><br>
                    Development Authority - <a href="javascript:void(0)" onclick="Lucknow_Zone_Ownership('${zoneNo}', 'ownership', 'Development Authority'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership Lucknow Development Authority');" style="color:#f16a16;">${data.count_lda}</a><br>
                    Railway - <a href="javascript:void(0)" onclick="Lucknow_Zone_Ownership('${zoneNo}','ownership','Railway'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership Railway');" style="color:#f16a16;">${data.count_railway}</a><br>
                    NHAI - <a href="javascript:void(0)" onclick="Lucknow_Zone_Ownership('${zoneNo}','ownership','NHAI'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership NHAI');" style="color:#5aeee5;">${data.count_nhai}</a><br>
                    Defence - <a href="javascript:void(0)" onclick="Lucknow_Zone_Ownership('${zoneNo}','ownership','Defence'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership Defence');" style="color:#ed2323;">${data.count_defence}</a><br>
                    C.M Grid - <a href="javascript:void(0)" onclick="Lucknow_Zone_Ownership('${zoneNo}','ownership','C.M Grid'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership C.M Grid');" style="color:#5aeee5;">${data.count_grid}</a><br>
                    Department Roads - <a href="javascript:void(0)" onclick="Lucknow_Zone_Ownership('${zoneNo}','ownership','Department Roads'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership Department Roads');" style="color:#f16a16;">${data.count_department}</a><br>
                    Institutional Roads - <a href="javascript:void(0)" onclick="Lucknow_Zone_Ownership('${zoneNo}','ownership','Institutional Road'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership Institutional Roads');" style="color:#ed2323;">${data.count_institutional}</a><br>
                  `
                    },
                    {
                        title: 'CUS',
                        value: `
                        14th Finance - <a href="javascript:void(0)" onclick="Lucknow_Zone_CUS('${zoneNo}','cus','14th Finance'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS 14th Finance');" style="color: #ec1248;">${data.count_14th}</a><br>
                        ...
                        PWD - <a href="javascript:void(0)" onclick="Lucknow_Zone_CUS('${zoneNo}','cus','PWD'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS PWD');" style="color: #173dd6;">${data.count_cus_pwd}</a><br>
                        Private - <a href="javascript:void(0)" onclick="Lucknow_Zone_CUS('${zoneNo}','cus','Private'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS Private');" style="color: #14ea54;">${data.count_cus_pvt}</a><br>
                        Duda - <a href="javascript:void(0)" onclick="Lucknow_Zone_CUS('${zoneNo}','cus','Duda'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS Duda');" style="color: #d4b85a;">${data.count_cus_duda}</a><br>
                        LDA - <a href="javascript:void(0)" onclick="Lucknow_Zone_CUS('${zoneNo}','cus','LDA'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS LDA');" style="color: #e6497d;">${data.count_cus_lda}</a><br>
                        Railway - <a href="javascript:void(0)" onclick="Lucknow_Zone_CUS('${zoneNo}','cus','Railway'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS Railway');" style="color: #8717e2;">${data.count_cus_railway}</a><br>
                        NA- <a href="javascript:void(0)" onclick="Lucknow_Zone_CUS('${zoneNo}','cus','NA'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS NA');" style="color: #bad057;">${data.count_cus_na}</a><br>
                        Others - <a href="javascript:void(0)" onclick="Lucknow_Zone_CUS('${zoneNo}','cus_class','Others'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS Others');" style="color: orange;">${data.count_cus_others}</a><br>
                    ...
                    Sub Arterial - <a href="javascript:void(0)" onclick="Lucknow_Zone_TypeSub('${zoneNo}','category','Subarterial'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Category Sub Arterial');" style="color: #83e45c;">${data.count_subarterial}</a><br>
                    ...
                    .then(responseData => {
                        if (responseData.status) {
                            ...
                            const details = [
                                ...
                                {
                                    title: 'Total Road Length',
                                    value: `<a href="javascript:void(0)" onclick="Lucknow_Zone_no('ward_no', '${wardNo}'); updateNavBarWithFunctionName('Ward-${wardNo} Total Road Length');" style="color:black;">${responseData.length_km} km</a>`
                                },
                                {
                                    title: 'Total No. of Roads',
                                ...
                                {
                                    title: 'Road Condition',
                                    value: `Good - <a href="javascript:void(0)" onclick="Lucknow_Ward_Condition('${wardNo}', 'condition', 'Good'); updateNavBarWithFunctionName('Ward-${wardNo} Road Condition Good');" style="color:green;">${responseData.count_green}</a> 
                                <br> Moderate - <a href="javascript:void(0)" onclick="Lucknow_Ward_Condition('${wardNo}', 'condition', 'Moderate'); updateNavBarWithFunctionName('Ward-${wardNo} Road Condition Moderate');" style="color:yellow;">${responseData.count_yellow}</a> 
                                <br> Poor - <a href="javascript:void(0)" onclick="Lucknow_Ward_Condition('${wardNo}', 'condition', 'Poor'); updateNavBarWithFunctionName('Ward-${wardNo} Road Condition Poor');" style="color:red;">${responseData.count_red}</a>
                                `
                        ...
                        Stone <a href="javascript:void(0)" onclick="Lucknow_Ward_Material('${wardNo}','material','Stone'); updateNavBarWithFunctionName('Ward-${wardNo} Road Material Stone');" style="color:#f228ab;">- ${responseData.count_stone}</a> <br>
                         ...
                         `
                                ...
                                Private Roads <a href="javascript:void(0)" onclick="Lucknow_Ward_Ownership('${wardNo}','ownership','Private'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership Private Roads');" style="color:#ed2323;">- ${responseData.count_pvt}</a><br>
                                Development Authority - <a href="javascript:void(0)" onclick="Lucknow_Ward_Ownership('${wardNo}', 'ownership', 'Development Authority'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership Lucknow Development Authority');" style="color:#f16a16;">${responseData.count_lda}</a><br>
                                Railway - <a href="javascript:void(0)" onclick="Lucknow_Ward_Ownership('${wardNo}','ownership','Railway'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership Railway');" style="color:#f16a16;">${responseData.count_railway}</a><br>
                                NHAI - <a href="javascript:void(0)" onclick="Lucknow_Ward_Ownership('${wardNo}','ownership','NHAI'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership NHAI');" style="color:#5aeee5;">${responseData.count_nhai}</a><br>
                                Defence - <a href="javascript:void(0)" onclick="Lucknow_Ward_Ownership('${wardNo}','ownership','Defence'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership Defence');" style="color:#ed2323;">${responseData.count_defence}</a><br>
                                C.M Grid - <a href="javascript:void(0)" onclick="Lucknow_Ward_Ownership('${wardNo}','ownership','C.M Grid'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership C.M Grid');" style="color:#5aeee5;">${responseData.count_grid}</a><br>
                                Department Roads - <a href="javascript:void(0)" onclick="Lucknow_Ward_Ownership('${wardNo}','ownership','Department Roads'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership Department Roads');" style="color:#f16a16;">${responseData.count_department}</a><br>
                                Institutional Roads - <a href="javascript:void(0)" onclick="Lucknow_Ward_Ownership('${wardNo}','ownership','Institutional Road'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership Institutional Roads');" style="color:#ed2323;">${responseData.count_institutional}</a><br>
                                `
                                },
                                {
                                    title: 'CUS',
                                    ...
                                    14th Finance - <a href="javascript:void(0)" onclick="Lucknow_Ward_CUS('${wardNo}','cus','14th Finance'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS 14th Finance');" style="color: #ec1248;">${responseData.count_14th}</a><br>
                                    ...
                                    PWD - <a href="javascript:void(0)" onclick="Lucknow_Ward_CUS('${wardNo}','cus''PWD'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS PWD');" style="color: #173dd6;">${responseData.count_cus_pwd}</a><br>
                                    Private - <a href="javascript:void(0)" onclick="Lucknow_Ward_CUS('${wardNo}','cus''Private'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS Private');" style="color: #14ea54;">${responseData.count_cus_pvt}</a><br>
                                    Duda - <a href="javascript:void(0)" onclick="Lucknow_Ward_CUS('${wardNo}','cus''Duda'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS Duda');" style="color: #d4b85a;">${responseData.count_cus_duda}</a><br>
                                    ...
                                    Railway - <a href="javascript:void(0)" onclick="Lucknow_Ward_CUS('${wardNo}','cus''Railway'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS Railway');" style="color: #8717e2;">${responseData.count_cus_railway}</a><br>
                                    NA- <a href="javascript:void(0)" onclick="Lucknow_Ward_CUS('${wardNo}','cus','NA'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS NA');" style="color: #bad057;">${responseData.count_cus_na}</a><br>
                                    Others- <a href="javascript:void(0)" onclick="Lucknow_Ward_CUS('${wardNo}','cus_class','Others'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS Others');" style="color: orange;">${responseData.count_cus_others}</a><br>
                                ...
                                Sub Arterial - <a href="javascript:void(0)" onclick="Lucknow_Ward_TypeSub('${wardNo}','category','Subarterial'); updateNavBarWithFunctionName('Ward-${wardNo} Road Category Sub Arterial');" style="color: #83e45c;">${responseData.count_subarterial}</a><br>
    ...
    `;
     ...
     color: rgba(4, 4, 99, 1); 
    padding: 10px 13px;
    border-radius: 10px;border-left: 4px solid #3772a7ff;
...
">
  ...
  <div><strong>Length (Km) :</strong> ${properties.length_km || 'N/A'}</div>
  <div><strong>Road Name :</strong> ${properties.road_name || 'N/A'}</div>
        ...
        `;
            ...
            //     const toBody = document.getElementById('dataBody_summary'); // ✅ correct tbody ID
            //     if (toBody) toBody.innerHTML = ''; // clear old rows safely

            //     loadPageData(); // Load first batch

            //     // Add scroll listener only once
            //     container.onscroll = function () {
            //         if (!isLoading && hasMore &&
            //             container.scrollTop + container.clientHeight >= container.scrollHeight - 100) {
            //             loadPageData(); // load next page
            //         }
            //     };
            // }
            ...
            // console.log("✅ Total records:", responseData.total_records);
            // console.log("✅ Data array length:", responseData.data?.length);

            //             if (!responseData.status || !Array.isArray(responseData.data)) return;
            ...
            //                 progressLabel.innerText = `Loaded ${loaded} / ${total} roads`;
            //             }
            ...
            //     const dataTableBody_summary = document.getElementById('dataBody_summary'); // ✅ fix target tbody
        ...
        `;
            ...
            /*function Lucknow_Zone_Type(zone_no, column, value) {
                removeCurrentLayer();
              //  clearVectorLayers(); 
                ...
                currentLayer = new ol.layer.Image({
                    source: new ol.source.ImageWMS({
                        url: `${GEOSERVER_BASE_URL}/wms`,
                        params: {
                            'LAYERS': 'Lko_Summary:lucknow_road_type',   // Main layer for filtering
                            'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                            'TILED': true
                        },
                        ratio: 1,
            ...
            document.querySelectorAll(".fa-print").forEach(printBtn => {
                printBtn.addEventListener("click", () => {
                    ...
                    // 1️⃣ Export Table to Excel
                    const wb = XLSX.utils.book_new();
                    const ws = XLSX.utils.table_to_sheet(table);
                    XLSX.utils.book_append_sheet(wb, ws, "FilteredData");
                    XLSX.writeFile(wb, `Filtered_Table_${Date.now()}.xlsx`);

                    // 2️⃣ Expand Map to Full Screen for Printing
                    const mapElement = document.getElementById("map"); // change ID if your map div differs
                    ...
                    mapElement.style.height = "140vh";
                    mapElement.style.zIndex = "9999";
                    mapElement.style.background = "#fff";

                    // Force map re-render before print
                    if (typeof map !== "undefined" && map.updateSize) {
                        map.updateSize();
                    }

                    // 3️⃣ Wait a moment, then print and restore
                    setTimeout(() => {
                        window.print();
