...
var view = new ol.View({
    ...
    center: [77.41576385381098,28.680297174584433],
    zoom: 12,
});
...
var zone_boundary = new ol.layer.Image({
    ...
    source: new ol.source.ImageWMS({
        url: "http://localhost:8080/geoserver/GNN/wms?",
        params: {
            LAYERS: "GNN:GNN Zone Boundary ",
        },
        ratio: 1,
...
var ward_boundary = new ol.layer.Image({
    ...
    source: new ol.source.ImageWMS({
        url: "http://localhost:8080/geoserver/GNN/wms?",
        params: {
            LAYERS: "GNN:Ghaziabad Ward Boundary",
        },
        ratio: 1,
        serverType: "geoserver",
    }),
...
function Ghaziabad_Road() {
    ...
    currentLayer = new ol.layer.Image({
        ...
        //     extent: [-180, -90, -180, 90],
        source: new ol.source.ImageWMS({
            url: 'http://localhost:8080/geoserver/GNN_Road_System/wms',
            params: {
                'LAYERS': 'GNN_Road_System:GNN Road Center Line',
