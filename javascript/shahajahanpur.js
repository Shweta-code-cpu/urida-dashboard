const BASE_URL = "http://192.168.219.117:8385/Gorakhpur";
...
var view = new ol.View({
    ...
    center: [79.9150822648616,27.8755253131586],
    zoom: 12.5,
});
...
var zone_boundary = new ol.layer.Image({
    title: "Shahjahanpur Zone Boundary",
    //  extent: [-180, -90, -180, 90],
    source: new ol.source.ImageWMS({
        url: "http://localhost:8080/geoserver/All_NN_Boundaries/wms?",
        params: {
            LAYERS: "	All_NN_Boundaries:Zone_Boundary_Shahjahanpur",
        },
        ratio: 1,
...
var ward_boundary = new ol.layer.Image({
    title: "Shahjahanpur Ward Boundary",
    //  extent: [-180, -90, -180, 90],
    source: new ol.source.ImageWMS({
        url: "http://localhost:8080/geoserver/All_NN_Boundaries/wms?",
        params: {
            LAYERS: "All_NN_Boundaries:Shahjahanpur_Ward_Boundary",
        },
        ratio: 1,
        serverType: "geoserver",
    }),
...
function clearAllVectorLayers() {
    ...
    map.getLayers().getArray().slice().forEach(layer => {
        if ((layer instanceof ol.layer.Tile || layer instanceof ol.layer.Image) &&
            ...
            if (layer.get('title') !== 'Shahjahanpur Zone Boundary' && layer.get('title') !== 'Shahjahanpur Ward Boundary') {
...
function Shahjahanpur_Road() {
    //  removeCurrentLayer();
  
      currentLayer = new ol.layer.Image({
          title: 'Shahjahanpur Road',
          source: new ol.source.ImageWMS({
              url: 'http://localhost:8080/geoserver/All_NN_roads/wms',
              params: {
                  'LAYERS': 'All_NN_roads:Shahjahanpur_Road',
              },
              ratio: 1,
              serverType: 'geoserver'
          })
              ...
              fetch(url)
                  ...
                  .then((data) => {
                      if (data.features && data.features.length > 0) {
                          ...
                          popup.innerHTML = `
                           <table style=background-color:white;width:270px; ><tr style=background-color:white;><td><strong>Field Name</strong></td><td><strong>Value</strong></td></tr>
                       <tr style=background-color:skyblue;><td> <strong>Zone No.</strong></td><td> ${properties.Zone_No || 'N/A'}</td></tr>
                         <tr style=background-color:skyblue;><td> <strong>Zone Name</strong></td><td> ${properties.Zone_Name || 'N/A'}</td></tr>

                      <tr style=background-color:skyblue;><td> <strong>Ward No.</strong></td><td> ${properties.Ward_No || 'N/A'}</td></tr>
                         <tr style=background-color:skyblue;><td> <strong>Ward Name</strong></td><td> ${properties.Ward_Name || 'N/A'}</td></tr>

                         <tr style=background-color:skyblue;><td> <strong>Right of Way</strong></td><td> ${properties.ROW_Meter || 'N/A'}</td></tr>
                           <tr style=background-color:skyblue;><td> <strong>Carriage Width</strong></td><td> ${properties.Carriage_W || 'N/A'}</td></tr>
                         <tr style=background-color:skyblue;><td> <strong>Type</strong></td><td> ${properties.Type || 'N/A'}</td></tr>
                          <tr style=background-color:skyblue;><td> <strong>Condition</strong></td><td> ${properties.Condition || 'N/A'}</td></tr>
                           <tr style=background-color:skyblue;><td> <strong>Material</strong></td><td> ${properties.Carriage_M || 'N/A'}</td> </tr>
                             <tr style=background-color:skyblue;><td> <strong>Ownership</strong></td><td> ${properties.Ownership || 'N/A'}</td></tr>
                               <tr style=background-color:skyblue;><td> <strong>Length(Km)</strong></td><td> ${properties.Length_KM || 'N/A'}</td></tr>
                                <tr style=background-color:skyblue;><td> <strong>Road Name</strong></td><td> ${properties.Road_Name || 'N/A'}</td></tr>
                                </table>
                          `;
...
//         //     extent: [-180, -90, -180, 90],
//         source: new ol.source.ImageWMS({
//             url: 'http://localhost:8080/geoserver/Mosaic_Shahjahanpur/wms',
//             params: {
//                 'LAYERS': '	Mosaic_Shahjahanpur:Shahjahanpur Road',
