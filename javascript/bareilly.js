//const BASE_URL = "http://192.168.100.178:8080/BareillyDashboard/Bareilly";
...
function showTables() {
    ...
    hideElements([ 'legendBtn', 'live_legend', 'type_legend', 'Condition_legend','CUS_legend','RoadCategory_legend','Material_legend', 'Ownership_legend',
        ...
        // 'tableContainer_summaryfiltermat', // 'tableContainer_summaryfilterOwn',
...
function showTables2() {
    ...
    hideElements([ 'dataTable', 'tableContainer_summary','tableContainer_summaryfilter', 'tableContainer', //'Scoring_dataTable', 'Scoreing_tableContainer','tableContainer_Drain', 'dataTable_Drain',
        ...
        // 'tableContainer_summaryfiltermat' ,'tableContainer_summaryfilterOwn',//'Priority_legend', 'Drain_Type_Legend',
...
const data1 = {
    'Summary':{},
    'Zone 1': { wards: ['Ward 22', 'Ward 23', 'Ward 24', 'Ward 27', 'Ward 30', 'Ward 31', 'Ward 36', 'Ward 37', 'Ward 38', 'Ward 42', 'Ward 44', 'Ward 45', 'Ward 47', 'Ward 52', 'Ward 56', 'Ward 58', 'Ward 59', 'Ward 63', 'Ward 66',  'Ward 68',  'Ward 73',  'Ward 74',  'Ward 76'] },
    ...
    const summaryData = {
        ...
        'Road Count by Material': {
            value: `
                ...
                NA - <a href="javascript:void(0)" onclick="Bareilly_Material_cat('material','NA'); updateNavBarWithFunctionName('Road Material NA');" style="color:#dfc223;">${safeValue('count_NA')}</a>
                `,
        ...
        'Road Count by CUS': {
            value: `
                14th Finance - <a href="javascript:void(0)" onclick="Bareilly_CUS_cat('cus','14th Finance'); updateNavBarWithFunctionName('Road CUS 14th Finance');" style="color: #ec1248;">${safeValue('count_14th')}</a><br>
                15th Finance - <a href="javascript:void(0)" onclick="Bareilly_CUS_cat('cus','15th Finance'); updateNavBarWithFunctionName('Road CUS 15th Finance');" style="color: #e63dee;">${safeValue('count_15th')}</a><br>
                Nagar Nigam Nidhi - <a href="javascript:void(0)" onclick="Bareilly_CUS_cat('cus','Nagar Nigam Nidhi'); updateNavBarWithFunctionName('Road CUS Nagar Nigam Nidhi');" style="color: cyan;">${safeValue('count_nnn')}</a><br>
                PWD - <a href="javascript:void(0)" onclick="Bareilly_CUS_cat('cus','PWD'); updateNavBarWithFunctionName('Road CUS PWD');" style="color: #173dd6;">${safeValue('count_cus_pwd')}</a><br>
                SFC - <a href="javascript:void(0)" onclick="Bareilly_CUS_cat('cus','SFC'); updateNavBarWithFunctionName('Road CUS SFC');" style="color: #14ea54;">${safeValue('count_cus_sfc')}</a><br>
                Vidhayak Nidhi - <a href="javascript:void(0)" onclick="Bareilly_CUS_cat('cus','Vidhayak Nidhi'); updateNavBarWithFunctionName('Road CUS Vidhayak Nidhi');" style="color: #6e52e7;">${safeValue('count_cus_vidhayak')}</a><br>
                Sansad Nidhi - <a href="javascript:void(0)" onclick="Bareilly_CUS_cat('cus','Sansad Nidhi'); updateNavBarWithFunctionName('Road CUS Sansad Nidhi');" style="color: #c70ed8;">${safeValue('count_cus_sansad')}</a><br>
                Duda - <a href="javascript:void(0)" onclick="Bareilly_CUS_cat('cus','Duda'); updateNavBarWithFunctionName('Road CUS Duda');" style="color: #d4b85a;">${safeValue('count_cus_duda')}</a><br>
                GN City - <a href="javascript:void(0)" onclick="Bareilly_CUS_cat('cus','GN City'); updateNavBarWithFunctionName('Road CUS GN City');" style="color: #e14a22;">${safeValue('count_cus_gncity')}</a><br>
                RES - <a href="javascript:void(0)" onclick="Bareilly_CUS_cat('cus','RES'); updateNavBarWithFunctionName('Road CUS RES');" style="color: #e6497d;">${safeValue('count_cus_res')}</a><br>
                Twarit Yojna - <a href="javascript:void(0)" onclick="Bareilly_CUS_cat('cus','TWARIT YOJANA'); updateNavBarWithFunctionName('Road CUS TWARIT YOJANA');" style="color: #1cdad1;">${safeValue('count_cus_twarit')}</a><br>
                Bareilly Smart City - <a href="javascript:void(0)" onclick="Bareilly_CUS_cat('cus','Bareilly Smart city'); updateNavBarWithFunctionName('Road CUS Bareilly Smart City');" style="color: #f4ee40;">${safeValue('count_cus_bareillysmartcity')}</a><br>
                NAGAR PANCHAYAT NIDHI - <a href="javascript:void(0)" onclick="Bareilly_CUS_cat('cus','NAGAR PANCHAYAT NIDHI'); updateNavBarWithFunctionName('Road CUS NAGAR PANCHAYAT NIDHI');" style="color: #bad057;">${safeValue('count_cus_panchayat')}</a><br>
                UP Bridge Corporation Ltd - <a href="javascript:void(0)" onclick="Bareilly_CUS_cat('cus','Up Bridge Corporation Ltd'); updateNavBarWithFunctionName('Road CUS UP Bridge Corporation Ltd');" style="color: #45d1a5;">${safeValue('count_cus_bridge')}</a><br>
                NA - <a href="javascript:void(0)" onclick="Bareilly_CUS_cat('cus','NA'); updateNavBarWithFunctionName('Road CUS NA');" style="color: #8717e2;">${safeValue('count_cus_na')}</a><br>
                `
            ,
        ...
        'Road Count by Category': {
            value: `
                ...
                Sub Arterial - <a href="javascript:void(0)" onclick="Bareilly_TypeSub_cat('category','Subarterial'); updateNavBarWithFunctionName('Road Category Subarterial');" style="color: #83e45c;">${safeValue('count_subarterial')}</a><br>
    ...
    const zoneCards = [
        ...
        { 
            ...
            value: `Bitumen <a href="javascript:void(0)" onclick="Bareilly_Zone_Material('${zoneNo}','material','Bitumen'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Material Bitumen');" style="color:darkred;">- ${data.bitumen}</a> <br>
                    ...
                    Kachcha <a href="javascript:void(0)" onclick="Bareilly_Zone_Material('${zoneNo}','material','Kachcha'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Material Kachcha');" style="color:#6036d0;">- ${data.kachcha}</a>`
        },
        { 
            title: 'Ownership', 
            value: `BNN <a href="javascript:void(0)" onclick="Bareilly_Zone_Ownership('${zoneNo}','ownership','BNN'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership Bareilly Nagar Nigam');" style="color:#5aeee5;">- ${data.knn}</a> <br>
                 ...
                 {
                    title: 'CUS',
                    value: ` 14th Finance - <a href="javascript:void(0)" onclick="Bareilly_Zone_CUS('${zoneNo}','cus','14th Finance'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS 14th Finance');" style="color: #ec1248;">${data.count_finance14th}</a><br>
                        15th Finance - <a href="javascript:void(0)" onclick="Bareilly_Zone_CUS('${zoneNo}','cus','15th Finance'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS 15th Finance');" style="color: #e63dee;">${data.count_finance15th}</a><br>
                        Nagar Nigam Nidhi - <a href="javascript:void(0)" onclick="Bareilly_Zone_CUS('${zoneNo}','cus','Nagar Nigam Nidhi'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS Nagar Nigam Nidhi');" style="color:cyan;">${data.count_nnn1}</a><br>
                        PWD - <a href="javascript:void(0)" onclick="Bareilly_Zone_CUS('${zoneNo}','cus','PWD'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS PWD');" style="color: #173dd6;">${data.count_pwd}</a><br>
                        SFC - <a href="javascript:void(0)" onclick="Bareilly_Zone_CUS('${zoneNo}','cus','SFC'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS SFC');" style="color: #14ea54;">${data.count_sfc}</a><br>
                        Vidhayak Nidhi- <a href="javascript:void(0)" onclick="Bareilly_Zone_CUS('${zoneNo}','cus','Vidhayak'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS Vidhayak');" style="color: #6e52e7;">${data.count_vidhayak}</a><br>
                        Sansad Nidhi - <a href="javascript:void(0)" onclick="Bareilly_Zone_CUS('${zoneNo}','cus','Sansad Nidhi'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS Sansad Nidhi');" style="color: #c70ed8;">${data.count_sansad}</a><br>
                        DUDA - <a href="javascript:void(0)" onclick="Bareilly_Zone_CUS('${zoneNo}','cus','Duda'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS DUDA');" style="color: #d4b85a;">${data.count_duda}</a><br>
                        GN City - <a href="javascript:void(0)" onclick="Bareilly_Zone_CUS('${zoneNo}','cus','GN City'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS GN City');" style="color: #e14a22;">${data.count_gncity}</a><br>
                        RES - <a href="javascript:void(0)" onclick="Bareilly_Zone_CUS('${zoneNo}','cus','RES'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS RES');" style="color: #e6497d;">${data.count_res}</a><br>
                        TWARIT YOJANA - <a href="javascript:void(0)" onclick="Bareilly_Zone_CUS('${zoneNo}','cus','TWARIT YOJANA'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS TWARIT YOJANA');" style="color: #1cdad1;">${data.count_twarit}</a><br>
                        Bareilly Smart City - <a href="javascript:void(0)" onclick="Bareilly_Zone_CUS('${zoneNo}','cus','Bareilly Smart City'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS Bareilly Smart City');" style="color: #e1ca4c;">${data.count_bareillysmartcity}</a><br>
                        Nagar Panchayat Nidhi - <a href="javascript:void(0)" onclick="Bareilly_Zone_CUS('${zoneNo}','cus','NAGAR PANCHAYAT NIDHI'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS Nagar Panchayat Nidhi');" style="color: #f4ee40;">${data.count_panchayat}</a><br>
                        UP Bridge Corporation Ltd - <a href="javascript:void(0)" onclick="Bareilly_Zone_CUS('${zoneNo}','cus','Up Bridge Corporation Ltd'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS UP Bridge Corporation Ltd');" style="color: #45d1a5;">${data.count_bridge}</a><br>
 
                        NA - <a href="javascript:void(0)" onclick="Bareilly_Zone_CUS('${zoneNo}','cus','NA'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS NA');" style="color: #8717e2;">${data.count_na}</a><br>
                        ...
                        `  },
               {
                ...
                value: `
                    ...
                    Sub Arterial - <a href="javascript:void(0)" onclick="Bareilly_Zone_TypeSub('${zoneNo}','category','Subarterial'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Category Subarterial');" style="color: #83e45c;">${data.count_subarterial}</a><br>
                ...
                const details = [
                    ...
                    { 
                        ...
                        value: `BNN - <a href="javascript:void(0)" onclick="Bareilly_Ward_Ownership('${wardNo}', 'ownership','BNN'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership Bareilly Nagar Nigam');" style="color:#5aeee5;">${responseData.knn}</a> 
                                ...
                                <br> Development Authority - <a href="javascript:void(0)" onclick="Bareilly_Ward_Ownership('${wardNo}', 'ownership', 'KDA'); updateNavBarWithFunctionName('Ward-${wardNo} Road Ownership Bareilly Development Authority');" style="color:#f16a16;">${responseData.kda}</a>
                                `
                            },
                            {
                                title: 'CUS',
                                value: ` 14th Finance - <a href="javascript:void(0)" onclick="Bareilly_Ward_CUS('${wardNo}','cus','14th Finance'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS 14th Finance');" style="color: #ec1248;">${responseData.finance14th}</a><br>
                                    15th Finance - <a href="javascript:void(0)" onclick="Bareilly_Ward_CUS('${wardNo}','cus','15th Finance'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS 15th Finance');" style="color: #e63dee;">${responseData.finance15th}</a><br>
                                    Nagar Nigam Nidhi - <a href="javascript:void(0)" onclick="Bareilly_Ward_CUS('${wardNo}','cus','Nagar Nigam Nidhi'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS Nagar Nigam Nidhi');" style="color:cyan;">${responseData.nnn}</a><br>
                                    PWD - <a href="javascript:void(0)" onclick="Bareilly_Ward_CUS('${wardNo}','cus','PWD'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS PWD');" style="color: #14ea54;">${responseData.sfc}</a><br>
                                    SFC - <a href="javascript:void(0)" onclick="Bareilly_Ward_CUS('${wardNo}','cus','SFC'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS SFC');" style="color: #173dd6;">${responseData.pwd}</a><br>
                                    Vidhayak Nidhi - <a href="javascript:void(0)" onclick="Bareilly_Ward_CUS('${wardNo}','cus','Vidhayak Nidhi'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS Vidhayak Nidhi');" style="color: #6e52e7;">${responseData.vidhayak}</a><br>
                                    Sansad Nidhi - <a href="javascript:void(0)" onclick="Bareilly_Ward_CUS('${wardNo}','cus','Sansad Nidhi'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS Sansad Nidhi');" style="color: #c70ed8;">${responseData.sansad}</a><br>
                                    DUDA - <a href="javascript:void(0)" onclick="Bareilly_Ward_CUS('${wardNo}','cus','Duda'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS DUDA');" style="color: #d4b85a;">${responseData.duda}</a><br>
                                    GN City - <a href="javascript:void(0)" onclick="Bareilly_Ward_CUS('${wardNo}','cus','GN City'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS GN City');" style="color: #e14a22;">${responseData.gncity}</a><br>
                                    RES - <a href="javascript:void(0)" onclick="Bareilly_Ward_CUS('${wardNo}','cus','RES'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS RES');" style="color: #e6497d;">${responseData.res}</a><br>
                                    Twarit Yojana - <a href="javascript:void(0)" onclick="Bareilly_Ward_CUS('${wardNo}','cus','TWARIT YOJANA'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS Twarit Yojana');" style="color: #1cdad1;">${responseData.twarit}</a><br>
                                    Bareilly Smart City - <a href="javascript:void(0)" onclick="Bareilly_Ward_CUS('${wardNo}','cus','Bareilly Smart City'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS Bareilly Smart City');" style="color: #f4ee40;">${responseData.bareillysmartcity}</a><br>
                                    Nagar Panchayat Nidhi - <a href="javascript:void(0)" onclick="Bareilly_Ward_CUS('${wardNo}','cus','NAGAR PANCHAYT NIDHI'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS Nagar Panchayat Nidhi');" style="color: #bad057;">${responseData.panchayat}</a><br>
                                    UP Bridge Corporation Ltd - <a href="javascript:void(0)" onclick="Bareilly_Zone_CUS('${zoneNo}','cus','Up Bridge Corporation Ltd'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS UP Bridge Corporation Ltd');" style="color: #45d1a5;">${data.count_bridge}</a><br>

                                    NA - <a href="javascript:void(0)" onclick="Bareilly_Ward_CUS('${wardNo}','cus','NA'); updateNavBarWithFunctionName('Ward-${wardNo} Road CUS NA');" style="color: #8717e2;;">${responseData.na}</a><br>
                                    ...
                                    `  },
                           {
                            ...
                            value: `
                                ...
                                Sub Arterial - <a href="javascript:void(0)" onclick="Bareilly_Ward_TypeSub('${wardNo}','category','Subarterial'); updateNavBarWithFunctionName('Ward-${wardNo} Road Category Subarterial');" style="color: #83e45c;">${responseData.count_subarterial}</a><br>
...
function highlightFeatureOnMap(gisId) {
    let wfsUrl = `${GEOSERVER_BASE_URL}/wfs?service=WFS&version=1.1.0&request=GetFeature
        &typename=BRL_Summary:bareilly_road
        &outputFormat=application/json
                ...
                fetch(url)
                    ...
                    .then(data => {
                        if (data.features && data.features.length > 0) {
                            ...
                            const centerCoordinate = map.getCoordinateFromPixel(centerPixel);
...
function Bareilly_Road_Length_Count() {
    ...
    currentLayer = new ol.layer.Image({
        ...
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'BRL_Summary:bareilly_road',
...
//             url: `${GEOSERVER_BASE_URL}/wms`,
//             params: {
//                 'LAYERS': 'BRL_Summary:z2ann_slum_boundary',
...
//             url: `${GEOSERVER_BASE_URL}/wms`,
//             params: {
//                 'LAYERS': 'BRL_Summary:z2ann_slum_roads',
...
$(document).ready(function () {
    ...
    var wfsParams = {
        ...
        typeName: 'BRL_Summary:bareilly_road',   // Replace with your WFS layer typename
    ...
    const url = `${GEOSERVER_BASE_URL}/wfs?service=WFS&version=1.0.0&request=GetFeature&typeName=BRL_Summary:bareilly_road&outputFormat=application/json`;
...
function updateMapLayer(zoneNo) {
    ...
    currentLayer = new ol.layer.Tile({
        source: new ol.source.TileWMS({
            ...
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'BRL_Summary:bareilly_road',   // Replace with your actual layer name
                'TILED': true,
...
function updateMapLayertype(type1) {
    ...
    currentLayer = new ol.layer.Tile({
        source: new ol.source.TileWMS({
            ...
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'BRL_Summary:bareilly_road_category',   // Replace with your actual layer name
                'TILED': true,
...
function updateMapLayermaterial(material) {
    ...
    currentLayer = new ol.layer.Tile({
        source: new ol.source.TileWMS({
            ...
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'BRL_Summary:bareilly_road_mat',   // Replace with your actual layer name
                'TILED': true,
                'CQL_FILTER': cqlFilter // Apply single filter
            },
            ratio: 1,
...
function updateMapLayerownership(ownership) {
    ...
    currentLayer = new ol.layer.Tile({
        source: new ol.source.TileWMS({
            ...
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'BRL_Summary:bareilly_road_own',   // Replace with your actual layer name
                'TILED': true,
                'CQL_FILTER': cqlFilter // Apply single filter
            },
            ratio: 1,
...
function updateTableWithFilteredData(cqlFilter) {
    const dataTableBody_summaryfilter = document.getElementById('dataBody_summaryfilter');
    const wfsUrl = `${GEOSERVER_BASE_URL}/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=BRL_Summary:bareilly_road_category&outputFormat=application/json&CQL_FILTER=${encodeURIComponent(cqlFilter)}`;
...
function updateTableWithFilteredDatamat(cqlFilter) {
    ...
    const wfsUrl = `${GEOSERVER_BASE_URL}/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=BRL_Summary:bareilly_road_mat&outputFormat=application/json&CQL_FILTER=${encodeURIComponent(cqlFilter)}`;
...
function updateTableWithFilteredDataOwn(cqlFilter) {
    ...
    const wfsUrl = `${GEOSERVER_BASE_URL}/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=BRL_Summary:bareilly_road_own&outputFormat=application/json&CQL_FILTER=${encodeURIComponent(cqlFilter)}`;
...
/*function Bareilly_Type_cat(column, value) {
    removeCurrentLayer();
  //  clearVectorLayers();
    // Define dynamic CQL filter
    let cqlFilter = `(${column}='${value}' OR ${column} ILIKE '%/${value}' OR ${column} ILIKE '${value}/%' OR ${column} ILIKE '%/${value}/%' OR ${column} ILIKE '${value}')`;
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'BRL_Summary:Bareilly_road_type',   // Same layer for all filters
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
/*function Bareilly_Zone_Type(zone_no, column, value) {
    removeCurrentLayer();
  //  clearVectorLayers(); 
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'BRL_Summary:Bareilly_road_type',   // Main layer for filtering
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
/*function Bareilly_Ward_Type(ward_no, column, value) {
    removeCurrentLayer();
   // clearVectorLayers();
