...
document.getElementById('nagarNigamSelect').addEventListener('change', function() {
    ...
    dashboardButton.onclick = function() {
        if (selectedCity === 'lucknow') {
            ...
            window.location.href = 'gorakhpur.html';
        }
        else if (selectedCity === 'shahjahapur') {
            window.location.href = 'shahjahanpur.html';
        } 
        else if (selectedCity === 'prayagraj') {
            window.location.href = 'prayagraj.html';
        }
        else if (selectedCity === 'kanpur') {
            window.location.href = 'kanpur.html';
        } 
           ...
           window.location.href = 'Meerut.html';
       } 
       else if (selectedCity === 'bareilly') {
           window.location.href = 'bareilly.html';
       }
       else if (selectedCity === 'aligarh') {
           window.location.href = 'aligarh.html';
       } 
       else if (selectedCity === 'moradabad') {
           window.location.href = 'moradabad.html';

        }  
       else if (selectedCity === 'saharanpur') {
            window.location.href = 'saharanpur.html';
        } 
        else if (selectedCity === 'jhansi') {
            window.location.href = 'jhansi.html';
        }
        else if (selectedCity === 'firozabad') {
            window.location.href = 'Firozabad.html';
        } 
        else if (selectedCity === 'mathura') {
            window.location.href = 'mathura.html';}
